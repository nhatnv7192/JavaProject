						...
						<div class="navbar-collapse collapse"
							...
							<div class="nav-outer">
								<ul class="nav navbar-nav">
									...
									<li class="dropdown hidden-sm"><a href='<c:url value="category/1.html"><c:param name="arrange" value="" /></c:url>'>Health & Beauty <span class="menu-label new-menu hidden-xs">new</span>
									</a></li>

									<li class="dropdown hidden-sm"><a href="'<c:url value="category/1.html"><c:param name="arrange" value="" /></c:url>'">Watches</a>
									</li>
													...
													<div class="row">
														...
														<div class="col-xs-12 col-menu">
															<ul class="links">
																...
																<li><a
																	href='<c:url value="category/1.html"><c:param name="arrange" value=""/></c:url>'>Category</a></li>
																<li><a
																	href='<c:url value="detail.html"><c:param name="productId" value="1"/></c:url>'>Detail</a></li>
				...
				<div class='col-md-3 sidebar'>
					<div class="sidebar-module-container">
						<div class="home-banner outer-top-n">
							<img src="../images/tongdai/8.jpg" alt="Image">
						</div>
										...
										<div class="item">
											<div class="products">
												<div class="hot-deal-wrapper">
													<div class="image">
														<img src="${product_hot_deals.imageUrl }" alt="">
													</div>
													<div class="sale-offer-tag">
														<span>${product_hot_deals.discount }%<br> off
														</span>
													</div>
												...
												<div class="product-info text-left m-t-20">
													<h3 class="name">
														<a href="detail.html">${product_hot_deals.name}</a>
													</h3>
													<div class="rating rateit-small"></div>
													<div class="product-price">
														<span class="price">${product_hot_deals.price - (product_hot_deals.price * product_hot_deals.discount /100) }
														</span> <span class="price-before-discount">$
															${product_hot_deals.price }</span>
													</div>
													<!-- /.product-price -->
						...
						<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
							<div id="advertisement" class="advertisement">
								<div class="item">
									<div class="avatar">
										<img src="../images/tongdai/1.jpg" alt="Image">
									</div>
								...
								<div class="item">
									<div class="avatar">
										<img src="../images/tongdai/3.jpg" alt="Image">
									</div>
									<div class="testimonials">
										<em>"</em> Vtae sodales aliq uam morbi non sem lacus port
										mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em>
				...
				<div class='col-md-9'>
						...
						<div class="row  wow fadeInUp">
									...
									<div id="owl-single-product">
										<div class="single-product-gallery-item" id="slide1">
											<a data-lightbox="image-1" data-title="Gallery"
												href="${productDetail.imageUrl }"> <img
												class="img-responsive" alt=""
												src="${productDetail.imageUrl }"
												data-echo="${productDetail.imageUrl }" />
											</a>
										</div>
										...
										<div id="owl-single-product-thumbnails">
											<div class="item">
												<a class="horizontal-thumb active"
													...
													href="#slide1"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											...
											<div class="item">
												<a class="horizontal-thumb"
													...
													href="#slide2"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="3"
													href="#slide3"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="4"
													href="#slide4"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="5"
													href="#slide5"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="6"
													href="#slide6"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="7"
													href="#slide7"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="8"
													href="#slide8"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
											<div class="item">
												...
												<a class="horizontal-thumb"
													data-target="#owl-single-product" data-slide="9"
													href="#slide9"> <img class="img-responsive" width="85"
													alt="" src="${productDetail.imageUrl }"
													data-echo="${productDetail.imageUrl }" />
												</a>
											</div>
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									...
									<div class="description-container m-t-20">Lorem ipsum
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="price-box">
													<span class="price">$ ${productDetail.price - (productDetail.price * productDetail.discount/100) }</span>
													<span class="price-strike">$ ${productDetail.price }
													</span>
												</div>
											</div>
									...
									<div class="quantity-container info-container">
										<div class="row">
											...
											<div class="col-sm-7">
												<a href='<c:url value="pluscartdetail.html"><c:param name="productId" value="${productDetail.productId }"/></c:url>' class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
											</div>
										</div>
										<!-- /.row -->
									</div>
									...
									<div id="description" class="tab-pane in active">
										<div class="product-tab">
											<p class="text">
												...
												minim veniam, quis nostrud exercitation ullamco laboris nisi
												ut aliquip ex ea commodo consequat.<br> <br> Duis
					...
					<section class="section featured-product wow fadeInUp">
						...
						<div
							...
							<c:forEach var="listUpsell" items="${listProduct}">
								<c:if test="${listUpsell.description =='new'}">
										...
										<div class="products">
											...
											<div class="product">
												...
												<div class="product-info text-left">
													<h3 class="name">
														<a href="detail.html">${listUpsell.name}</a>
													</h3>
													<div class="rating rateit-small"></div>
													<div class="description"></div>

													<div class="product-price">
														<span class="price"> $ ${listUpsell.price - (listUpsell.price * listUpsell.discount/100)}
														</span> <span class="price-before-discount">$
															${listUpsell.price}</span>
					...
					<div id="brand-slider"
						...
						<div class="item m-t-15">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand1.png"
								src="../images/brands/brand1.png" alt="">
							</a>
						</div>
						<!--/.item-->
						...
						<div class="item m-t-10">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand2.png"
								src="../images/brands/brand2.png" alt="">
							</a>
						</div>
						<!--/.item-->
						...
						<div class="item">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand3.png"
								src="../images/brands/brand3.png" alt="">
							</a>
						</div>
						<!--/.item-->
						...
						<div class="item">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand4.png"
								src="../images/brands/brand4.png" alt="">
							</a>
						</div>
						<!--/.item-->
						...
						<div class="item">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand5.png"
								src="../images/brands/brand5.png" alt="">
							</a>
						</div>
						<!--/.item-->
						...
						<div class="item">
							<a href="#" class="image"> <img
								data-echo="../images/brands/brand6.png"
								src="../images/brands/brand6.png" alt="">
							</a>
						</div>
						<!--/.item-->
