...
<div class="body-content">
	...
	<span class="title-tag inner-top-ss">Please enter your Name , Address,Email in the box below and press Enter. This was given to you on your receipt and in the confirmation email you should have received. </span>
	<form class="register-form outer-top-xs" role="form" action="order.html" method="post">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Name</label><br/>
		    <input type="text" name="name" required="required">
		</div>
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Address</label><br/>
		    <input type="text" size="40" name="address" required="required">
		</div>
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Phone</label><br/>
		    <input type="number" size="40" name="phone" required="required">
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleBillingEmail1">Email</label><br/>
		    <input type="email"  name="email" required="required">
		</div>
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" onclick="alert('Order complete......')">Order</button>
	</form>	
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
		<!-- ============================================== BRANDS CAROUSEL ============================================== -->
		...
		<div class="logo-slider-inner">	
			<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
				<div class="item m-t-15">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand1.png" src="../images/brands/brand1.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item m-t-10">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand2.png" src="../images/brands/brand2.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand3.png" src="../images/brands/brand3.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand4.png" src="../images/brands/brand4.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand5.png" src="../images/brands/brand5.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../images/brands/brand6.png" src="../images/brands/brand6.png" alt="">
					</a>	
				</div><!--/.item-->
