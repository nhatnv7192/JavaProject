							...
							<div class="row">
									...
									<div class="col-xs-12 col-menu">
	                                  <ul class="links">
											...
											<li><a href='<c:url value="category/1.html"><c:param name="arrange" value="" /></c:url>'></a></li>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="../images/product_new/clother/1.jpg">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="../images/product_new/clother/2.jpg">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="../images/product_new/clother/3.jpg">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="../images/product_new/clother/4.jpg">
										</a>
									</div>
