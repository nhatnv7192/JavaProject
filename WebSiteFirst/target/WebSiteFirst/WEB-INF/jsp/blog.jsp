...
<div class="body-content">
	...
	<a href="blog-details.html"><img class="img-responsive" src="../images/lungtung/blog.jpg" alt=""></a>
...
<div class="blog-post outer-top-bd  wow fadeInUp">
	<a href="blog-details.html"><img class="img-responsive" src="../images/lungtung/blog1.jpg" alt=""></a>
	<h1><a href="blog-details.html">Nemo enim ipsam voluptatem quia voluptas sit aspernatur</a></h1>
...
<div class="blog-post outer-top-bd  wow fadeInUp">
	<a href="blog-details.html"><img class="img-responsive" src="../images/lungtung/blog2.jpg" alt=""></a>
	<h1><a href="blog-details.html">Nemo enim ipsam voluptatem quia voluptas sit aspernatur</a></h1>
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="tab-content" style="padding-left:0">
	   <div class="tab-pane active m-t-20" id="popular">
		...
		<div class="blog-post" >
			<img class="img-responsive" src="../images/lungtung/blog2.jpg" alt="">
			<h4><a href="blog-details.html">Simple Blog Post</a></h4>
			<span class="review">6 Comments</span>
	...
	<div class="tab-pane m-t-20" id="recent">
		<div class="blog-post inner-bottom-30" >
			<img class="img-responsive" src="../images/lungtung/blog3.jpg" alt="">
			<h4><a href="blog-details.html">Simple Blog Post</a></h4>
			<span class="review">6 Comments</span>
		...
		<div class="logo-slider-inner">	
			<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
				<div class="item m-t-15">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand1.png" src="../assets/images/brands/brand1.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item m-t-10">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand2.png" src="../assets/images/brands/brand2.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand3.png" src="../assets/images/brands/brand3.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand4.png" src="../assets/images/brands/brand4.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand5.png" src="../assets/images/brands/brand5.png" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="../assets/images/brands/brand6.png" src="../assets/images/brands/brand6.png" alt="">
					</a>	
				</div><!--/.item-->
