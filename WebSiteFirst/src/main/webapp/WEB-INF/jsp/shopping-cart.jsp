...
<div class="body-content outer-top-xs">
	...
	<div class="table-responsive">
		<table class="table">
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="checkout.html" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
			...
			<c:forEach var="cart" items="${cart.getCartItems().entrySet()}">
				<tr>
					<td class="romove-item"><a href='<c:url value="removecart.html"><c:param name="productId" value="${cart.getValue().getProduct().getProductId()}"/><c:param name="page" value="shopping-cart"/></c:url>' title="cancel" class="icon"><i class="fa fa-trash-o"></i></a></td>
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="${cart.getValue().getProduct().getImageUrl()}" alt="">
						</a>
					</td>
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="detail.html">${cart.getValue().getProduct().getName()}</a></h4>
						<div class="row">
							<div class="col-sm-4">
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
				                ...
				                <input type="text" value="${cart.getValue().getQuantity()}">
			              </div>
		            </td>
					<td class="cart-product-sub-total"><span class="cart-sub-total-price">$ ${cart.getValue().getProduct().getPrice()}</span></td>
					<td class="cart-product-grand-total"><span class="cart-grand-total-price">$ ${cart.getValue().getQuantity() * cart.getValue().getProduct().getPrice() }</span></td>
				</tr>
			</c:forEach>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
